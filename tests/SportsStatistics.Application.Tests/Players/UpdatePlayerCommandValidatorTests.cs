...
public class UpdatePlayerCommandValidatorTests
{
    ...
    [Fact]
    public async Task UpdatePlayerCommandValidator_Should_NotHaveValidationError()
    {
        // Arrange.
    ...
    [InlineData("")]
    [InlineData("    ")]
    public async Task UpdatePlayerCommandValidator_Should_HaveValidationError_Name_WhenEmpty(string name)
    {
        // Arrange.
    ...
    [Fact]
    public async Task UpdatePlayerCommandValidator_Should_HaveValidationError_Name_WhenExceedsMaximumLength()
    {
        // Arrange.
    ...
    [InlineData(0)]
    [InlineData(100)]
    public async Task UpdatePlayerCommandValidator_Should_HaveValidationError_SquadNumber_OutsideRange(int squadNumber)
    {
        // Arrange.
    ...
    [Fact]
    public async Task UpdatePlayerCommandValidator_Should_NotHaveValidationError_WhenSquadNumberTakenByCurrentPlayer()
    {
        // Arrange.
        var command = BaseCommand;
    ...
    [Fact]
    public async Task UpdatePlayerCommandValidator_Should_HaveValidationError_WhenSquadNumberTakenByAnotherPlayer()
    {
        // Arrange.
        var command = BaseCommand;
    ...
    [InlineData("")]
    [InlineData("    ")]
    public async Task UpdatePlayerCommandValidator_Should_HaveValidationError_Nationality_WhenEmpty(string nationality)
    {
        // Arrange.
    ...
    [Fact]
    public async Task UpdatePlayerCommandValidator_Should_HaveValidationError_Nationality_WhenExceedsMaximumLength()
    {
        // Arrange.
        var sb = new StringBuilder();
        while (sb.Length <= 100)
    ...
    [Fact]
    public async Task UpdatePlayerCommandValidator_Should_HaveValidationError_DateOfBirth_WhenEmpty()
    {
        // Arrange.
    ...
    [Fact]
    public async Task UpdatePlayerCommandValidator_Should_HaveValidationError_DateOfBirth_WhenLessThanFifteenYearsOld()
    {
        // Arrange.
    ...
    [InlineData("")]
    [InlineData("    ")]
    public async Task UpdatePlayerCommandValidator_Should_HaveValidationError_Position_WhenEmpty(string position)
    {
        // Arrange.
    ...
    [InlineData("Attacker")]
    public async Task UpdatePlayerCommandValidator_Should_NotHaveValidationError_Position(string position)
    {
        // Arrange.
        var command = BaseCommand with { Position = position };
    ...
    [Fact]
    public async Task UpdatePlayerCommandValidator_Should_HaveValidationError_Position_WhenInvalid()
    {
        // Arrange.
